...
namespace webview_cs
{
    ...
    public delegate void webview_external_invoke_cb_t(
        IntPtr webview,
    ...
    public static class Ffi
    {
        ...
        [DllImport("webview", CallingConvention = CallingConvention.Cdecl)]
        public static extern UIntPtr webview_alloc(
            [MarshalAs(UnmanagedType.LPUTF8Str)] string title,
            [MarshalAs(UnmanagedType.LPUTF8Str)] string url,
            int width,
            int height,
        ...
        [DllImport("webview", CallingConvention = CallingConvention.Cdecl)]
        public static extern void webview_release(UIntPtr webview);

        // WEBVIEW_API int webview_init(struct webview *w);
        [DllImport("webview", CallingConvention = CallingConvention.Cdecl)]
        public static extern int webview_init(UIntPtr webview);
        
        // WEBVIEW_API int webview_loop(struct webview *w, int blocking);
        [DllImport("webview", CallingConvention = CallingConvention.Cdecl)]
        public static extern int webview_loop(UIntPtr webview, int blocking);
        ...
        [DllImport("webview", CallingConvention = CallingConvention.Cdecl)]
        public static extern void webview_exit(UIntPtr webview);
